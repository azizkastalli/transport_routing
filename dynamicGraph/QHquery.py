...
def queryAlgorithm(G, source, target, curr_time, stations_coord, walk_speed=1.4, max_StationDistance=np.inf, transfer_time=150, walk_panalisation=True, unrestricted_maxwalk = 300 ):
    ...
    while queue:
        ...
        while i < n :
            ...
            #walk Switch -> Switch
                ...
                ntrans  = trans  + 1     #keep tracking transitions between stops
            ...
            if neighbor in enqueued:
                ...
                if not ((qcost > ncost) or (ncost == qcost and qtrans > ntrans)):
                    continue
